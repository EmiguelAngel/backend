...
public class MercadoPagoController {
    ...
    public ResponseEntity<?> createPreference(@RequestBody PreferenceDTO request) {
        try {
            ...
            logger.info("Back URLs: {}", request.getBackUrls());
    ...
    public ResponseEntity<?> testCredentials() {
        ...
        try {
            ...
            logger.info("Calling MercadoPago service...");
            String preferenceId = mercadoPagoService.createPreference(testDTO);
            logger.info("Success! Preference ID: {}", preferenceId);
            ...
            logger.error("Error testing MercadoPago credentials: {}", e.getMessage(), e);
